...
public class LBSUtils {
    ...
    public static void main(String[] args) {
        LBSUtils addressUtils = new LBSUtils();
        // 测试ip 219.136.134.157 中国=华南=广东省=广州市=越秀区=电信
        //122.49.20.247 101.6.19.51
        String ip = "101.6.19.51";
        String address = "";
        try {
        ...
        //        System.out.println("访客IP："+ipAddress+"访客所在地区："+address+"用户访问来源："+terminal+"访问URL："+request.getRequestURL());
    }
}
